...
def departments():   
    data_departments = [('d001','Marketing'),
        ('d002','Finance'),
    ...
    add_departments = ("INSERT INTO departments "
               "(dept_no, dept_name)"
               "VALUES (%s, %s)")
    cursor.executemany(add_departments, data_departments)
    cnx.commit()
...
def employees():
    ...
    cursor.executemany(add_employees, data_employees)
    cnx.commit()
...
def dept_manager():
    data_dept_manager = [
        ...
        (10014,'d002','1989-12-17','9999-01-01'),
        (10083,'d003','1985-01-01','1992-03-21'),
        (10028,'d003','1992-03-21','9999-01-01'),
        (10003,'d004','1985-01-01','1988-09-09'),
        (10044,'d004','1988-09-09','1992-08-02'),
        (10086,'d004','1992-08-02','1996-08-30'),
        (10020,'d004','1996-08-30','9999-01-01'),
        ...
        (10001,'d006','1991-09-12','1994-06-28'),
        (10054,'d006','1994-06-28','9999-01-01'),
        (10035,'d007','1985-01-01','1991-03-07'),
        (10033,'d007','1991-03-07','9999-01-01'),
        (10099,'d008','1985-01-01','1991-04-08'),
    ...
    add_dept_manager = ("INSERT INTO dept_manager "
               "(emp_no, dept_no, from_date, to_date)"
               "VALUES (%s, %s, %s, %s)")
    cursor.executemany(add_dept_manager, data_dept_manager)
    cnx.commit()
...
def dept_emp():
    ...
    cursor.executemany(add_dept_emp, data_dept_emp)
    cnx.commit()
    
def titles():
    data_titles = [(10001,'Senior Engineer','1986-06-26','9999-01-01'),
        ...
        (10100,'Staff','1996-09-21','9999-01-01')]
    
    add_titles = ("INSERT INTO titles "
               "(emp_no, title, from_date, to_date)"
               "VALUES (%s, %s, %s, %s)")
    cursor.executemany(add_titles, data_titles)
    cnx.commit()
...
def salaries():   
    ...
    add_salaries = ("INSERT INTO salaries "
